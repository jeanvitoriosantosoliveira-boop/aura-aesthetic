...
const Offer = () => (
  <section id="contato" className="relative grain bg-gradient-noir py-20 md:py-32 overflow-hidden">
    ...
    <div className="container relative">
      <Reveal>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-8 font-display text-4xl leading-[1.05] text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
            Sua primeira <span className="font-italic-serif text-gradient-gold">avaliação</span><br />
            por nossa conta.
          </h2>

          <p className="mt-6 text-base text-foreground/75 leading-relaxed sm:text-lg">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <Button asChild variant="ghostLux" size="xl" className="w-full border-foreground/30 text-foreground hover:bg-foreground hover:text-background sm:w-auto">
          ...
          <div className="mt-10 inline-flex items-center gap-2 text-[10px] tracking-elegant uppercase text-foreground/60 sm:text-xs">
